...
Qualitative comparison of the BungeeNeRF dataset under 12/24 input view settings

<img src="images/bungeenerf.png" width="800">

Quantitative comparison of the BungeeNeRF dataset under 12/24 input view settings.The best and second results for each metric are highlighted.
